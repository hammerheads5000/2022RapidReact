...
public class RobotContainer {
  ...
  */
  ...
  private final BumperShotCommand cmd_bumperShotCommand = new BumperShotCommand(sub_shooterSubsystem, sub_feedSubsystem);
  private final SafeZoneShotCommand cmd_safeZoneShotCommand = new SafeZoneShotCommand(sub_shooterSubsystem, sub_feedSubsystem);
